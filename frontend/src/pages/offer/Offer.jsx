...
import { FaPlus, FaTrash, FaEdit, FaDownload, FaFilter, FaSearch } from "react-icons/fa"
...
export default function Offers() {
  ...
  const filteredProducts = products.filter((product) => {
    ...
    const matchesMinCoins = minCoins === "" || product.coinReward >= Number.parseInt(minCoins)

    const matchesMaxCoins = maxCoins === "" || product.coinReward <= Number.parseInt(maxCoins)

    return matchesSearch && matchesCategory && matchesMinCoins && matchesMaxCoins
  })

  const exportToCSV = () => {
    const headers = ["Product Name", "Product ID", "Category", "Coin Reward", "QR Count", "Description"]
    ...
    link.setAttribute("download", `offer_products_${new Date().toISOString().split("T")[0]}.csv`)
  ...
  const handleCheckId = async () => {
    ...
    try {
      const response = await api.post("/api/admin/check-offer-product-id", {
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#C3E8FF] to-white px-4 sm:px-6 lg:px-10 pt-7 pb-12 space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <h2 className="font-semibold text-black text-lg flex items-center">
          ...
          Offer Management ({filteredProducts.length} of {products.length})
        </h2>
        ...
        <div className="bg-white rounded-xl shadow-md p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="relative">
              <label className="block text-sm font-medium text-gray-700 mb-1">Search Offers</label>
              <div className="relative">
            ...
            {/* Min Coins */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Min Coins</label>
              <input
                type="number"
                placeholder="0"
                value={minCoins}
            ...
            {/* Max Coins */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Max Coins</label>
              <input
                type="number"
                placeholder="1000"
                value={maxCoins}
      ...
      {isPopupOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-40 flex items-center justify-center p-4">
          <div ref={popupRef} className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between p-6 border-b">
              <h3 className="text-xl font-semibold">{editingProduct ? "Edit Offer" : "Add New Offer"}</h3>
              <button onClick={closePopup}>
                <IoIosClose size={28} />
              </button>
            </div>
            <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">QR Count</label>
                <input
                  type="number"
                  min={1}
                  name="qrCount"
      ...
      {showIdPopup && (
        <div className="fixed inset-0 backdrop-blur-md flex items-center justify-center z-50">
          <div ref={checkIdRef} className="bg-white rounded-2xl p-6 w-[450px] relative space-y-5 shadow-lg">
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-bold text-black">Check Offer ID</h2>
                  ...
                  <div className="space-y-2 text-xs text-green-700">
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-green-800">{checkIdResult.data.qrStatus}</p>
                      </div>
                    </div>
